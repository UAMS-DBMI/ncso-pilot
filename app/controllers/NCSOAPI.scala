...
object NCSOAPI extends Controller {
    ...
    val list_of_APIS = List("getcurrentapis", "testsesameconnection", "getGeneralHealthMetricsForAllParticipants", "getParticipantsInNonSmokingHouseholds", "getParticipantsInSmokingHouseholds", "getGeneralHealthMetricsForNonSmokingHouseholds", "getGeneralHealthMetricsForSmokingHouseHolds", "getGeneralHealthMetricsForParticipantsInSmokingHouseholdsLessThanFifteenBMI", "getGeneralHealthAndSurrogateDataForAllParticipants", "getGeneralHealthDataForAllParticipants" )
